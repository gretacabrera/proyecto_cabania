<h1>Registrar ingreso al complejo</h1>
<?php
    if (isset($_SESSION["usuario_nombre"])){
        ...
        $mostrar = "<h2>No se ha encontrado una reserva iniciada en este momento.</h2>";
        ...
        echo "Para registrar un ingreso, primero debe iniciar sesión.";
    }
?>