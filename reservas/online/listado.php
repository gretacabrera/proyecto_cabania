...
?>
    ...
    <table>
        <thead>
            <th>
                <font face="Arial">Fecha y hora de Inicio</font>
            </th>
            <th>
                <font face="Arial">Fecha y hora de Fin</font>
            </th>
            <th width="200">
                <font face="Arial">Cabaña</font>
            </th>
            <th>
                <font face="Arial">Precio por dia</font>
            </th>
            <th>
                <font face="Arial">Importe total</font>
            </th>
            <th>
                <font face="Arial">Estado</font>
            </th>
            <th>
                <font face="Arial">Acciones</font>
            </th>
        </thead>
    <?php
    ...
    while ($row = $registros->fetch_assoc()) {
        ...
        echo "
            <tr>
                ...
                <td>";
        if (
            $row["estadoreserva_descripcion"] == "pendiente" |
